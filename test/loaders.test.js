...
test("normalizes Hugging Face metadata, LFS file sizes, and card data", async () => {
  ...
  try {
    ...
    assert.equal(modelPackage.files.find((file) => file.path === "README.md").text.includes("apache-2.0"), true);
